...
const UserManagement: React.FC = () => {
  ...
  const users = [
    { id: '1', username: 'admin', email: 'admin@company.com', employee_id: 'EMP001', role: 'admin' as UserRole, is_active: true, created_at: '2024-01-01', last_login: '2024-12-20' },
    { id: '2', username: 'hr.manager', email: 'hr@company.com', employee_id: 'EMP002', role: 'hr' as UserRole, is_active: true, created_at: '2024-01-15', last_login: '2024-12-19' },
    { id: '3', username: 'line.manager', email: 'manager@company.com', employee_id: 'EMP003', role: 'line_manager' as UserRole, is_active: true, created_at: '2024-02-01', last_login: '2024-12-18' },
    { id: '4', username: 'employee', email: 'employee@company.com', employee_id: 'EMP004', role: 'employee' as UserRole, is_active: true, created_at: '2024-02-15', last_login: '2024-12-17' },
  ];
      ...
      setTimeout(() => {
        const event = new CustomEvent('showToast', {
          detail: {
            ...
            message: `Password has been reset for ${username}. New password sent via email.`
          }
        });
        window.dispatchEvent(event);
      }, 100);
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="text-center">
            <div className="text-3xl font-bold text-orange-600 mb-1">
              {employees.filter(emp => emp.status === 'active' && !users.some(u => u.employee_id === emp.employee_id)).length}
            </div>
            <div className="text-sm text-gray-600">Available Employees</div>
          </div>
        </div>
      </div>
    </div>
